...
python3 -m verl.trainer.main \
    config=examples/FULLv3.yaml \
    worker.actor.model.model_path=${MODEL_PATH} \
    trainer.n_gpus_per_node=8


## /mnt/lyc/wuxinrui/R1_training/trained/7B_RL_FULLv1/7B_FULLv1_69step/models(8000-6000-4000均23step,此时2000-10000,各预计46step)