...
class CheckpointHandler(FileSystemEventHandler):
    def __init__(self, folder_path, max_checkpoints=5):
...
def main():
    folder_path = '/data/wuxinrui/LLaMA-Factory/TCMv2_long_short/steady_outputs'  # Change this to your path
    ...
    try:
        while True:
            ...
            time.sleep(300)  # Wait for 30 minutes
